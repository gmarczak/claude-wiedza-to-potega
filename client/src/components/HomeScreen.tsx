...
interface Props {
  onCreateRoom: (name: string, settings: GameSettings) => void;
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8 animate-slide-up">
          <h1 className="text-5xl font-black text-white text-shadow mb-2">
            Wiedza
          </h1>
        ...
        {mode === 'menu' && (
          <div className="space-y-4 animate-slide-up">
            <input
              ...
              maxLength={20}
              className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-xl text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-purple-400 focus:border-transparent text-lg"
            />
            <button
              onClick={() => setMode('create')}
              disabled={!playerName.trim()}
              className="w-full py-4 bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 text-white font-bold text-lg rounded-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-lg hover:shadow-xl"
            >
              Stwórz Pokój
            </button>
            <button
        ...
        {mode === 'create' && (
          <div className="space-y-4 animate-slide-up">
            <div className="bg-white/10 rounded-xl p-4 space-y-4">
              ...
              <div>
                <label className="block text-purple-200 text-sm mb-1">Liczba rund</label>
                <select
