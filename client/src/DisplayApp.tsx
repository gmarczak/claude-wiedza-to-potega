...
import GameScene from './display3d/GameScene';
...
export default function DisplayApp() {
  ...
  // ── enter-room screen (stays as plain HTML - no 3D needed) ──────────────────
  ...
  if (phase === 'enter-room') {
    return (
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100vh', gap: '1.5rem', background: '#0a0a0f' }}>
        ...
        <p style={{ color: '#00F5FF', fontSize: '1.3rem', fontFamily: 'Exo 2, sans-serif' }}>TRYB TV — ekran 3D</p>
        <p style={{ color: '#94a3b8', fontSize: '1rem' }}>Wpisz kod pokoju aby podłączyć ekran</p>
  ...
  return (
    <GameScene
      ...
      pyramidIntro={pyramidIntro}
      pyramidQuestion={pyramidQuestion}
      pyramidReveal={pyramidReveal}
